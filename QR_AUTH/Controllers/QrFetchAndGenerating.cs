...
namespace QR_AUTH.Controllers
{
    ...
    public class QrFetchAndGenerating : ControllerBase
    {
        ...
        public QrFetchAndGenerating(IHttpClientFactory httpClientFactory, IConfiguration configuration)
        {
            ...
            _document = DocX.Create(@"qr_codes.docx");
        ...
        private void DeleteFilesInFolder()
        {
            try
            {
                string[] pngFiles = Directory.GetFiles("./", "*.png", SearchOption.TopDirectoryOnly);
        ...
        public async Task<IActionResult> GetQr()
        {
            ...
            {
                DeleteFilesInFolder();
                var proxyUri = new Uri("http://192.168.12.2:3129"); // Замените адрес и порт на фактические значения
